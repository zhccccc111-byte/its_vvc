...
# min delay 0.200ns ensures hold margin (data arrives after clock skew at destination)
set_input_delay -clock clk_if -max 0.500 [get_ports {it_info[*]}]
set_input_delay -clock clk_if -min 0.200 [get_ports {it_info[*]}]
set_input_delay -clock clk_if -max 0.500 [get_ports {it_info_vld}]
set_input_delay -clock clk_if -min 0.200 [get_ports {it_info_vld}]
set_input_delay -clock clk_if -max 0.500 [get_ports {it_data_in[*]}]
set_input_delay -clock clk_if -min 0.200 [get_ports {it_data_in[*]}]
set_input_delay -clock clk_if -max 0.500 [get_ports {it_data_addr[*]}]
set_input_delay -clock clk_if -min 0.200 [get_ports {it_data_addr[*]}]
set_input_delay -clock clk_if -max 0.500 [get_ports {it_data_in_vld}]
set_input_delay -clock clk_if -min 0.200 [get_ports {it_data_in_vld}]
set_input_delay -clock clk_if -max 0.500 [get_ports {it_data_end}]
set_input_delay -clock clk_if -min 0.200 [get_ports {it_data_end}]
set_input_delay -clock clk_if -max 0.500 [get_ports {it_data_out_req}]
set_input_delay -clock clk_if -min 0.200 [get_ports {it_data_out_req}]

# Outputs (clk_if domain)
set_output_delay -clock clk_if -max 0.500 [get_ports {it_data_in_req}]
set_output_delay -clock clk_if -min 0.200 [get_ports {it_data_in_req}]
set_output_delay -clock clk_if -max 0.500 [get_ports {it_data_out[*]}]
set_output_delay -clock clk_if -min 0.200 [get_ports {it_data_out[*]}]
set_output_delay -clock clk_if -max 0.500 [get_ports {it_data_out_vld}]
set_output_delay -clock clk_if -min 0.200 [get_ports {it_data_out_vld}]
set_output_delay -clock clk_if -max 0.500 [get_ports {it_done}]
set_output_delay -clock clk_if -min 0.200 [get_ports {it_done}]
