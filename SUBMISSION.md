...
Latest verified results (v6.0):

| Target | Result |
|--------|--------|
| `its_top_500_singleclk` | 1539/1539 PASS |
...
## Official Q&A Compliance (v5.6-v6.0)

| Ref | Requirement | Fix |
|-----|-------------|-----|
| P0 #4 | 2D transform: vertical first, then horizontal | v5.6: ref_model + its_core_500 |
| P0 #11 | Next TU accepted before current output fully read | v5.7: TU metadata queue; v5.8: can_accept_tu hardening; v6.0: input end-marker closing window fixed |
...
- v6.0: its_top_500_singleclk 1539/1539 PASS, its_core_500 94/94 PASS.
- v6.0 UltraScale+ OOC: WNS +0.047ns, WHS +0.034ns at 500MHz, 0 failing endpoints.
