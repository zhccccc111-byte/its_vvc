...
**基线版本：2026-06-29 (v6.0)**
**仿真结果：singleclk 1539/1539 PASS + core_500 94/94 PASS**
**500MHz 状态：v6.0 `its_top_500_singleclk` OOC UltraScale+ (xcku5p-2) WNS +0.047ns / WHS +0.034ns 达标**
...
| P0 #11 TU metadata queue | v5.7: 4 深度队列 + v5.8: can_accept_tu 加固 + v6.0: input closing 窗口修复 ✅ |
| 单时钟提交顶层回归 | 1539/1539 PASS |
| UltraScale+ OOC (v6.0) | WNS +0.047ns, WHS +0.034ns, 0 failing ✅ |
...
| 赛题要求 | 完成状态 | 证据 |
|----------|----------|------|
| 工作主频 500MHz | **已满足** | its_top_500_singleclk OOC UltraScale+ (xcku5p-2) WNS +0.047ns / WHS +0.034ns (v6.0) |
...
| 时序 | **完成** | v6.0 UltraScale+ OOC WNS = +0.047ns / WHS = +0.034ns，500MHz **达标** |
