...
v6.0 在 v5.5 的 1537 个测试基础上新增 2 个 immediate overlap 专项测试，并修复 input end-marker closing 窗口，验证 P0 #11 TU metadata queue 协议正确性。
...
12. **CDC 验证**：wrapper 历史 1537 测试覆盖 async FIFO CDC 路径；最终提交顶层使用单时钟赛题接口，v6.0 重点验证 immediate overlap、反压、连续 TU、end_same_cycle 等协议压力场景
